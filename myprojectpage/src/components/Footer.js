        ...
        <footer>
            <div className="container-fluid">
                <nav className="navbar row my-3">
                    <Link className="ml-auto" to="/"><img className="logo-footer" src={logo} /></Link>
                    ...
                    <a href="https://twitter.com/Joshua___ig" target="_blank"><i className="fa-brands fa-2xl mx-3 fa-twitter"></i></a>
                </nav>
            </div>
        </footer>
    </>
